public class LowlandGorilla extends Gorilla implements Dangerable {
	...
	public LowlandGorilla(boolean isWarmBloodedIn, boolean hasFurIn, boolean isTiredIn, int weightIn, String soundIn,
			boolean isHungryIn, boolean isWildIn, boolean isPetIn, boolean isFriendlyIn, boolean isBipedalIn,
			boolean canClimbIn, String foodEatenIn, boolean isCaptiveIn, String gorillaSubspeciesIn, boolean isSilverBackIn,
			boolean livesInRainforestIn) {

		super(isWarmBloodedIn, hasFurIn, isTiredIn, weightIn, soundIn, isHungryIn, isWildIn, false, isFriendlyIn,
				isBipedalIn, canClimbIn, foodEatenIn, isCaptiveIn, gorillaSubspeciesIn);
