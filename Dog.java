public class Dog extends Canine {
	...
	public Dog(boolean isWildIn, boolean floppyEarsIn, boolean hasSpotsIn, boolean isFriendlyIn, String speciesNameIn,
			boolean isWarmBloodedIn, boolean hasFurIn, boolean isTiredIn, int weightIn, String soundIn, boolean isPetIn,
			String dogBreedIn, String furColorIn, boolean isHungryIn) {
